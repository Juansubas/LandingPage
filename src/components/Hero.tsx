    ...
    <section className=" h-[90vh] grid grid-cols-1 md:grid-cols-8">
      ...
      <div className="md:col-span-3 flex items-center justify-center relative">
        <div>
          ...
          />
          <div className="bg-white shadow-xl rounded-lg p-4 flex flex-col justify-center max-w-[250px] gap-2 mx-auto">
            <img
            ...
            <img
              ...
              className="w-10 h-10 object-contain rounded-full"
            />
            <h2 className="text-xl font-medium traking-[1px] text-gray-800">120 + Employees</h2>
