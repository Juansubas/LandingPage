  ...
  return (
    <section className=" min-h-[90vh] grid grid-cols-1 xl:grid-cols-8">
      ...
      <div className=" md:col-span-5 flex items-center justify-center p-8 xl:p-16">
        <div className="flex flex-col gap-8">
          <h1 className="text-5xl xl:text-7xl font-bold xl:leading-[7.5rem] ">
            ...
            <span className="text-primary py-2 px-10 border-8 border-primary relative inline-block">
              Products
      ...
      <div className="md:col-span-3 flex items-center justify-center relative">
        ...
        {/* Circle Section */}
        <div className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 md:w-[380px] md:h-[380px] w-[280px] h-[280px] bg-white border-[10px] border-primary rounded-full  -z-10  ">
        </div>
        {/* Logos */}
        ...
        <img src="/adobe.png" className="w-10 h-10 md:w-20 md:h-20 object-cover rounded-full border-l-8 border-gray-600 absolute top-[10%] xl:top-[2%] left-[20%] xl:left-[10%]" />
        <img src="/sketch.png" className="w-10 h-10 md:w-20 md:h-20 object-cover rounded-full absolute bottom-[5%] left-[15%] xl:left-[5%] bg-white -rotate-12" />
      </div>
    </section>
  );
};
